...
<body>
	...
	<header id="header">
		<a href="/index"><img id="logo_page" src="images/favicon.png" width="150px" height="70px"></a>My freestyle videos
	</header>
	<!--nav class="navbar navbar-expand-lg navbar-light bg-light"-->
	<nav class="navbar navbar-expand-sm bg-light">
		<ul class="navbar-nav">
			<a class="nav-link" href="/index">Index</a>
			<a class="nav-link" href="/tricks">Lower</a>
			<a class="nav-link" href="/uper">Upper</a>
			<a class="nav-link" href="#footer">Groundmoves</a>
			<a class="nav-link" href="/register">Register a new trick</a>
	...
	<section>
		...
		<div id="content">
			@section('content')
			<center><h2>Goods of lower freestyle</h2></center>
				<video width="28%" height="360" controls>
					<source src="videos/akim.mp4" type="video/mp4">
				</video>
				<video width="28%" height="360" controls>
