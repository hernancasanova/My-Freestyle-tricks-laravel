<?php $__env->startSection('content'); ?>
		...
		<div id="VideoTrick">
			<video id="video" width="100%" height="100%" controls>
				<source id="target" src="/videos/<?php echo e($trick->initials); ?>.wmv" type="video/mp4">
			</video>
		</div>	
		<script>
			function reproduc(){
...
<?php echo $__env->make('inicio', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hernan Casanova\Desktop\pruebas\laravel\MVF2\MVF\resources\views/show.blade.php ENDPATH**/ ?>